...
abstract class StructuredElementHandler<P extends StackedHandler<?>> extends StackedHandler<P>
{
	...
	protected Property addProperty(String name, Property.PropertyType type, String targetType, String targetSubtype, int size, boolean readOnly, UseparametersTypeField useparametersTypeField)
	{
